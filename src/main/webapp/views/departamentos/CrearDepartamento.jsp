...
<div class="container py-5">
  ...
  <form action="${pageContext.request.contextPath}/departamentos" method="post">
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="nombre" name="nombreDepartamento" required>
    </div>

    <div class="mb-3">
      <label for="descripcion" class="form-label">Descripción</label>
      <textarea class="form-control" id="descripcion" name="descripcionDepartamento" rows="3" required></textarea>
    </div>
